...
#define Roughness	texture2
#define HeightMap	texture3
#define Metallic	texture4
#define Occlusion	texture6
...
Vertex_shader_output_type main_vs(RGL_VS_INPUT In)
{
	...
	#define Generated_domain_shader_func_name standart_metal_rough_ds
...
PS_OUTPUT_TO_USE main_ps(Pixel_shader_input_type In)
{
	...
	sample_metal_roughness_textures(In , pp_static , pp_modifiable, pp_aux);
