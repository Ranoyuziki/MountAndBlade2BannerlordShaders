...
PS_OUTPUT_GBUFFER main_ps(Pixel_shader_input_type In)
{
	...
	sample_textures_deferred_decal(In , pp_static , pp_modifiable, pp_aux);
	calculate_alpha_deferred_decal(In , pp_static , pp_modifiable, pp_aux);
	apply_alpha_test(In, pp_modifiable.early_alpha_value);
	calculate_normal_deferred_decal(In , pp_static , pp_modifiable, pp_aux);
	calculate_albedo_deferred_brush_decal(In , pp_static , pp_modifiable, pp_aux);
	calculate_specularity_deferred_decal(In , pp_static , pp_modifiable, pp_aux);
	calculate_diffuse_ao_factor_decal_deferred(In , pp_static , pp_modifiable, pp_aux);
