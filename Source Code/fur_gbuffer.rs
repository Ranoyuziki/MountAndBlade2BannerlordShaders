...
PS_OUTPUT_GBUFFER main_ps(Pixel_shader_input_type In)
{
	...
	set_gbuffer_values(In, Output, pp_modifiable.world_space_normal, pp_modifiable.early_alpha_value, pp_modifiable.albedo_color, pp_modifiable.specularity, occlusion_info, pp_static.view_length);
