...
Vertex_shader_output_type main_vs(RGL_VS_INPUT In)
{
	...
	calculate_object_space_values_map_trees(In , pv_modifiable, Out );
	calculate_world_space_values_map_trees(In , pv_modifiable, Out );
	calculate_render_related_values_map_trees(In , pv_modifiable, Out );
