...
[earlydepthstencil]
#endif
PS_OUTPUT main_ps(Pixel_shader_input_type In, uint instance_id : SV_InstanceID, uint prim_id : SV_PrimitiveID)
{
...
#ifdef PIXEL_SHADER
compute_overdraw(In, In.position, instance_id, prim_id);
#endif
